		...
		2).创建主磁贴
		     与二级磁贴类似，只是用无参的构造函数声明
				...
				```
		HttpApp.Toolkit\Timers
		-DefaultTimer 定时器
		
		HttpApp.Toolkit\Utilitys
